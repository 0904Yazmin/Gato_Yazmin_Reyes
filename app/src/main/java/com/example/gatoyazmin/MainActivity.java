package com.example.gatoyazmin;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_p2 = findViewById(R.id.text_view_p2);
        textView_em = findViewById(R.id.text_view_em);
    ...
    private void updatePointsText() {
        textView_p1.setText("Jugador 1(X) :  " + jugador1Puntos);
        textView_p2.setText("Jugador 2(O) :  " + jugador2Puntos);
        textView_em.setText("Empates      :  " + empatesPuntos);
    }
